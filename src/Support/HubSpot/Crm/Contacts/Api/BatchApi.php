...
namespace LookstarKernel\Support\HubSpot\Crm\Contacts\Api;
...
class BatchApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\Contacts\Model\BatchInputSimplePublicObjectInput $batch_input_simple_public_object_input batch_input_simple_public_object_input (required)
     *
     * @throws \HubSpot\Client\Crm\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObjectWithErrors|\HubSpot\Client\Crm\Contacts\Model\Error
     */
     ...
     * Create a batch of contacts
     *
     * @param  \HubSpot\Client\Crm\Contacts\Model\BatchInputSimplePublicObjectInput $batch_input_simple_public_object_input (required)
     *
     * @throws \HubSpot\Client\Crm\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObjectWithErrors|\HubSpot\Client\Crm\Contacts\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($batch_input_simple_public_object_input)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 201:
                    if ('\HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObject' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObject' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObject', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 207:
                    if ('\HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObjectWithErrors' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObjectWithErrors' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObjectWithErrors', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            switch ($e->getCode()) {
                ...
                case 207:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Contacts\Model\BatchResponseSimplePublicObjectWithErrors',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
